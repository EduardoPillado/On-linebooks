...
<head>
  ...
  <title>On-linebooks | Perfil de usuario</title>
</head>
<body>
...
<div class="card-profile">
    ...
    <div class="card__title">
      <span style="display: flex; align-items: center;">
          <span id="username">{{ session('nombre_usuario', 'Nombre de Usuario') }}</span>
          <form>
          <a href="{{ route('usuario.mostrarFormularioEdicion', ['pkUsuario' => session('pk_usuario')]) }}" style="text-decoration: none;">
          </form>
            <svg id="edit-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16" style="margin-left: 4px; cursor: pointer;">
                <path d="M12.854.146a.5.5 0 0 1 .637-.057l.07.057 2.5 2.5a.5.5 0 0 1 0 .708l-9 9a.5.5 0 0 1-.233.13l-.084.02-3 1a.5.5 0 0 1-.671-.637l.057-.07 1-3a.5.5 0 0 1 .13-.232l9-9zm-1.207 2.5-9 9L2 14l1.854-.646 9-9L14.146 3 11.646.5zM4.854 12.146 3.5 13.5l1.646-.146zM11 1.207 14.293 4.5l-1.793 1.793L9.207 3 11 1.207z"></path>
            </svg>
        </a>
        
      </span>
  </div>
  <div class="card__subtitle">{{ session('correo_usuario', 'Correo de Usuario') }}</div>
  <div class="d-inline">
    <a href="{{ route('favoritos') }}" class="button2 btn-danger btn-sm">
        Favoritos
    </a> 
</div>
</div>
...
.card-profile {
  ...
  position: relative;
  width: 100%; /* Ocupa el 100% del ancho disponible por defecto */
  ...
  animation: fadeInUpScale 1s ease-in-out; /* Aplica la animación */
  transition: width 0.5s ease-in-out, max-width 0.5s ease-in-out; /* Transición para cambios de tamaño */
}
...
@media (min-width: 768px) {
  .card {
    max-width: 600px; /* Ancho máximo en pantallas más grandes */
  }
}
...
.card__btn-solid {
  width: 120px; /* Ajusta el ancho para dar suficiente espacio */
